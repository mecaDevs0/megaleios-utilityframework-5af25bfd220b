...
using UtilityFramework.Services.Vimeo.Core3.Net;
using UtilityFramework.Services.Vimeo.Core3.Models;
...
namespace UtilityFramework.Services.Vimeo.Core3
{
    ...
    public interface IVimeoClient
    {
        ...
        //Task<Paginated<Video>> GetVideosAsync(UserId userId, int? page = null, int? perPage = null, string query = null, string[] fields = null);
        ...
        /// <param name="fields">JSON filter, as per https://developer.vimeo.com/api/common-formats#json-filter </param>
        /// <returns>Paginated videos</returns>
        //Task<Paginated<Video>> GetAlbumVideosAsync(UserId userId, long albumId, int? page = null, int? perPage = null,string sort = null, string direction = null, string[] fields = null);
        ...
        /// <param name="replaceVideoId"></param>
        ...
        Task<IUploadRequest> UploadEntireFileAsync(IBinaryContent fileContent, int chunkSize = VimeoClient.DefaultUploadChunkSize, long? replaceVideoId = null, Action<double> statusCallback = null);

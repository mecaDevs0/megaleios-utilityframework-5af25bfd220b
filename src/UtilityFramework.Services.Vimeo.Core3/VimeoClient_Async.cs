...
using UtilityFramework.Services.Vimeo.Core3;
using UtilityFramework.Services.Vimeo.Core3.Authorization;
using UtilityFramework.Services.Vimeo.Core3.Constants;
using UtilityFramework.Services.Vimeo.Core3.Enums;
using UtilityFramework.Services.Vimeo.Core3.Exceptions;
...
namespace UtilityFramework.Services.Vimeo
{
    public partial class VimeoClient : IVimeoClient
    {
        ...
        protected const int DefaultUploadChunkSize = 1048576; // 1MB

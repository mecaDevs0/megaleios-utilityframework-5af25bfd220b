...
namespace UtilityFramework.Services.Iugu.Core3.Models
{
    public class IuguAccountFilesModel
    {
        ...
        /// </summary>
        [JsonProperty("selfie", NullValueHandling = NullValueHandling.Ignore)]
        ...
        /// </summary>
        [JsonProperty("balance_sheet", NullValueHandling = NullValueHandling.Ignore)]
        public string BalanceSheet { get; set; }

        /// <summary>
        /// Contrato Social. Obrigatório se person_type é Pessoa Jurídica
        /// </summary>
        [JsonProperty("social_contract", NullValueHandling = NullValueHandling.Ignore)]
        public string SocialContract { get; set; }

        /// <summary>
        /// Documento adicional 1
        /// </summary>
        [JsonProperty("additional_document_one", NullValueHandling = NullValueHandling.Ignore)]
        public string AdditionalDocumentOne { get; set; }

        /// <summary>
        /// Documento adicional 2
        /// </summary>
        [JsonProperty("additional_document_two", NullValueHandling = NullValueHandling.Ignore)]

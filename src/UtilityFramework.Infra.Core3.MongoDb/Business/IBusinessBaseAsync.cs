...
namespace UtilityFramework.Infra.Core3.MongoDb.Business
{
    public interface IBusinessBaseAsync<T> where T : class
    {
        ...
        /// <returns></returns>
        Task<string> UpdateOneAsync(T entity, bool setLastUpdate = true, bool cascade = false, bool inTask = false);
        ...
        /// <param name="setLastUpdate"></param>
        /// <returns></returns>
        Task<T> UpdateAsync(T entity, bool setLastUpdate = true, bool cascade = false, bool inTask = false);
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        string UpdateOne(T entity, bool cascade = false, bool inTask = false);
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        T Update(T entity, bool cascade = false, bool inTask = false);
        ...
        IMongoQuery ConvertToMongoQuery(FilterDefinition<T> filter);
    }
}
...
namespace UtilityFramework.Application.Core
{
    ...
    public class PathImage : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            try
            {
                ...
                {
                    return Utilities.RemovePathImage(reader.Value?.ToString());
                }
            }
            catch (Exception)
            {
        ...
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
        {
            try
            {
                ...
                if (value is List<string>)
                {
                    ...
                    t = JToken.FromObject(listPhotos.Select(x => Utilities.SetPathImage(x)));
                }
                else
                {
                    t = JToken.FromObject(Utilities.SetPathImage(value?.ToString()));
                }
    ...
    public class OnlyNumber : JsonConverter
    {
            ...
            JsonSerializer serializer)
        {
            try
            {
                return Utilities.OnlyNumbers(reader.Value?.ToString());
            }
            catch (Exception)
            {

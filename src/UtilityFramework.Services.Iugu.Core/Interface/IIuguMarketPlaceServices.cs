...
namespace UtilityFramework.Services.Iugu.Core.Interface
{
    ...
    public interface IIuguMarketPlaceServices
    {
        ...
        /// <summary>
        /// OBTER CREDENCIAIS DE TODAS OU DE UMA SUBCONTA
        /// </summary>
        ...
        /// <summary>
        /// METODO PARA VALIDAR ASSINATURA RSA (OBRIGATÓRIO ASSINAR REQUEST)
        /// </summary>
        /// <param name="model"></param>
        /// <param name="apiToken"></param>
        /// <returns></returns>
        Task<ValidadeSignatureResponseViewModel> ValidateSignature(object model, string apiToken = null);
        /// <summary>
        /// DESATIVAR SUBCONTA
        /// </summary>
        /// <param name="model"></param>
